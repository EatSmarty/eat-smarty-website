  ...
  return <div>
    <section className='contactus mt-20 text-2xl flex justefy-center items-center flex-col'>
        ...
        <div className='contact-box rounded flex justify-center items-center flex-col'>
            ...
            Hi! We are happy to hear from you. If you have any questions or comments about our project, please contact us. You can contact us via github issue. We are always looking for ways to improve our project,
