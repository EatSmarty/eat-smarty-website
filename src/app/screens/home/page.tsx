          ...
          <section className='history'>
            <div className='mt-10'>
              ...
              <ul className='history-list mt-3'>
                <li className='history-item rounded-sm mb-4 p-5 text-[#3C3D42]'>item1</li>
                <li className='history-item rounded-sm mb-4 p-5 text-[#3C3D42]'>item2</li>
                <li className='history-item rounded-sm mb-4 p-5 text-[#3C3D42]'>item3</li>
                <li className='history-item rounded-sm mb-4 p-5 text-[#3C3D42]'>item3</li>
                <li className='history-item rounded-sm mb-4 p-5 text-[#3C3D42]'>item3</li>
              </ul>
            </div>
